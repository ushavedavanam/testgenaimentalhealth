...
def generate_ai_response(response_type, user_input):
    ...
    if response_type == "Without Data Science and UX":
        ...
        prompt = f"{customization_info} Based on this input: '{user_input}', provide a data-driven response with quantitative analysis and external resource links. Please add metrics and percentages with each bullet in your response. The response should have metrics and numbers and percentages for each suggestion and also links the user can review."
        ...
        explanation = "This response combines data-driven insights with empathetic language, considering user history and online resources. The response should have metrics and numbers and percentages for each suggestion and also links the user can review."
        explanation = "This response leverages the user's work-related interests and conversation history, along with relevant resources."
